...
export const personalData = {
  ...
  summary:
    "I'm a Software Engineer with **5 years of experience**, currently working in the platform team at Humanforce. I currently build tooling to manage infrastructure for our Workforce Management application used by over **800,000 users**. I have also worked on productivity and performance challenges for products like Humanforce HR. I hold a **Bachelor's degree in Computer Science** from Queensland University of Technology. I enjoy exploring new tech in my free time.",
  avatarUrl: "/me-2.png",
} as const;
...
export const experiencesData = [
  {
    ...
    description: [
      "Software Engineer in the Platform team, building scalable platform services, internal tooling, and features for web applications serving 800k+ users using TypeScript, .NET, PHP, Laravel, GraphQL, React, Node.js, PostgreSQL, SQL Sever, and AWS.",
      ...
      "Reduced onboarding time for new customers by building data import tools using .NET and TypeScript Lambdas to handle data processing into a SQL Server database.",
      ...
      "Built backend APIs for the Humanforce HR–Thrive integration, allowing users to complete HR forms from the mobile app (Laravel, GraphQL, and PostgreSQL).",
      ...
      "Used agentic coding tools such as Claude Code and OpenCode to plan, implement and test features faster and to a high quality.",
