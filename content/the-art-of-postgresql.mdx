...
- **GiST** - non-ordered, geometric, ranges
- **SP-GiST** - uneven-density tries/quadtrees
- **GIN** - arrays, full-text, composite containment
...
- **BCNF/4NF/5NF/DKNF** - stricter guarantees; aim for BCNF/4NF in practice

Three classic anomalies from under-normalizing:

- **Update** - duplicated facts go out of sync
- **Insertion** - can't record one fact without an unrelated one
- **Deletion** - deleting one fact forces deleting another
